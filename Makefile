#############################################################################
# Makefile for building: pokemon_rpg.exe
# Generated by qmake (3.1) (Qt 5.9.4)
# Project:  pokemon_rpg.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile pokemon_rpg.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = pokemon_rpg1.0.0
DISTDIR = /cygdrive/c/Users/cs/Desktop/rpg3/.tmp/pokemon_rpg1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = pokemon_rpg.cpp moc_game.cpp
OBJECTS       = pokemon_rpg.o \
		moc_game.o
DIST          = /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		...
		pokemon_rpg.pro game.h pokemon_rpg.cpp
QMAKE_TARGET  = pokemon_rpg
DESTDIR       = 
TARGET        = pokemon_rpg.exe
...
Makefile: pokemon_rpg.pro /usr/lib/qt5/mkspecs/cygwin-g++/qmake.conf /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/qt5/mkspecs/common/unix.conf \
		/usr/lib/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/qt5/mkspecs/common/gcc-base.conf \
		/usr/lib/qt5/mkspecs/common/g++-base.conf \
		...
		/usr/lib/qt5/mkspecs/features/lex.prf \
		pokemon_rpg.pro
	$(QMAKE) -o Makefile pokemon_rpg.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents pokemon_rpg.cpp $(DISTDIR)/
...
moc_game.cpp: game.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt5/mkspecs/cygwin-g++ -I/cygdrive/c/Users/cs/Desktop/rpg3 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/lib/gcc/x86_64-pc-cygwin/12/include/c++ -I/usr/lib/gcc/x86_64-pc-cygwin/12/include/c++/x86_64-pc-cygwin -I/usr/lib/gcc/x86_64-pc-cygwin/12/include/c++/backward -I/usr/lib/gcc/x86_64-pc-cygwin/12/include -I/usr/include -I/usr/include/w32api game.h -o moc_game.cpp
...
pokemon_rpg.o: pokemon_rpg.cpp game.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pokemon_rpg.o pokemon_rpg.cpp
